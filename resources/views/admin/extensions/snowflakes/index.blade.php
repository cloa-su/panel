...
<?php 
    ...
    $EXTENSION_ID = "snowflakes";
    $EXTENSION_NAME = stripslashes("Snowflakes");
    $EXTENSION_VERSION = "1.0";
    $EXTENSION_DESCRIPTION = stripslashes("Add snowflakes to your Pterodactyl dashboard.");
    $EXTENSION_ICON = "/assets/extensions/snowflakes/icon.jpg";
    $EXTENSION_WEBSITE = "https://github.com/prplwtf/blueprint-snowflakes";
